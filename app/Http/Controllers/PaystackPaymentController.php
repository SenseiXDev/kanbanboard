...
class PaystackPaymentController extends Controller
{
    ...
    public function __construct()
    {
        ...
        if(isset($_REQUEST['from']) && $_REQUEST['from'] == 'invoice')
        {
            ...
            $this->currancy  = (isset($invoice->project)) ? $invoice->project->currency_code : 'NGN';
        }
        else
        {
                ...
                if($assignPlan['is_success'] == true && !empty($plan))
                {
                    ...
                    Order::create(
                        [
                            ...
                            'plan_id' => $plan->id,
                            'price' => $price,
                            'price_currency' => !empty($this->currancy) ? $this->currancy : 'ngn',
                            'txn_id' => '',
    ...
    public function invoicePayWithPaystack(Request $request)
    {
        ...
        $res_data['currency']    = !empty($this->currancy) ? $this->currancy : 'ngn';
        $res_data['flag']        = 1;
