...
<div class="response">
    <a class="btn btn-sm btn-primary rounded-pill float-left" href="#!" id="generate">{{ __('Generate') }}</a>
    <div class="text-right">
        <a href="#!" onclick="copyText()" class="btn btn-sm btn-primary rounded-pill"> <span><i class="fas fa-copy"></i></span> {{ __('Copy Text') }}</a>
        <a href="#!" onclick="copySelectedText()" class="btn btn-sm btn-primary rounded-pill"><span><i class="fas fa-copy"></i></span> {{ __('Copy Selected Text') }}</a>
    </div>
</div>
</form>
