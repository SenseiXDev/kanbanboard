                                                    ...
                                                    @foreach($invoice->items as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$border_color}};">
                                                            ...
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</pre>
                                                            </div>
                                                            <div class="d-table-td w-5 text-right">
                                                                <pre data-v-f2a183a6="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</pre>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                    </div>
                                                    @if($invoice->getTax())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                        </div>
                                                    @endif
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$border_color}}; border-bottom: 1px solid {{$border_color}};">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid {{$border_color}}; border-bottom: 1px solid {{$border_color}};">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Due Amount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
