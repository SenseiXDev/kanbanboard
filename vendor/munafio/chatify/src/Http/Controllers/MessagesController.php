...
class MessagesController extends Controller
{
    ...
    public function getContacts(Request $request)
    {
        ...
        {
            $members = User::where('created_by', '=', $objUser->id)->get();
        }
        else
        {
            $members = User::where('type', '!=', 'client')->where('created_by', '=', $objUser->created_by)->where('id', '!=', $objUser->id)->orWhere('id', '=', $objUser->created_by)->get();
        }
