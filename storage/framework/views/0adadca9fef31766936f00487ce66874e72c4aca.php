...
<div class="row">
    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <select name="language" class="form-select form-control px-3" id="language">
                <?php $__currentLoopData = App\Models\Utility::flagOfCountry(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($key); ?>" <?php echo e($currantLang == $key ? 'selected' : ''); ?>><?php echo e(ucfirst($lang)); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
    </div>
    ...
    <div class="col-6 tone">
        <div class="form-group">
            ...
            ?>
            <?php echo e(Form::select('tone',$tone,null,['class'=>'form-control tone'])); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <select name="ai_creativity" id="ai_creativity" class="form-select form-control px-3">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <select name="num_of_result" id="" class="form-select form-control px-3">
                <?php for($i = 1; $i <= 10; $i++): ?>
...
<div class="response">
    <a class="btn btn-sm btn-primary rounded-pill float-left" href="#!" id="generate"><?php echo e(__('Generate')); ?></a>
    <div class="text-right">
        <a href="#!" onclick="copyText()" class="btn btn-sm btn-primary rounded-pill"> <span><i class="fas fa-copy"></i></span> <?php echo e(__('Copy Text')); ?></a>
        <a href="#!" onclick="copySelectedText()" class="btn btn-sm btn-primary rounded-pill"><span><i class="fas fa-copy"></i></span> <?php echo e(__('Copy Selected Text')); ?></a>
    </div>
</div>
</form>
...
<?php /**PATH /home/u71832/domains/taskmanager.tenyne.com/public_html/resources/views/generate.blade.php ENDPATH**/ ?>